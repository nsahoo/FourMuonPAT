...
void ExoticmassFitRootScan() 
{

	// TFile *f1 = TFile::Open("Combined10em10Vtxcl.root");
	// TFile *f1 = TFile::Open("Combined10em20Vtxcl.root");
	TFile *f1 = TFile::Open("CombinedVertexCut10em30.root");
	// TFile *f1 = TFile::Open("Combined2011and2012Default.root");
	// TFile *f1 = TFile::Open("Muonia2011and2012Default.root");
	// TFile *f1 = TFile::Open("mycombinedwith4mvtxprobgt0.10.root");
	// TFile *f1 = TFile::Open("mycombinedwith4mvtxprobgt0.20.root");
	// TFile *f1 = TFile::Open("mycombinedwith4mvtxprobgt0.30.root");
	// TFile *f1 = TFile::Open("mycombinedwith4mvtxprobgt0.50.root");
	// TFile *f1 = TFile::Open("mycombinedwith4mvtxprobgt0.70.root");
	// TFile *f1 = TFile::Open("Combined2011and2012NoVertexCut.root");
...
*/
 ...
 // Default
	...
	RooRealVar c1("c1", "c1", -3.30550e-01,  -2.0, 2.0);
	RooRealVar c2("c2", "c2", -3.56383e-01,  -2., 2.0);
	RooRealVar c3("c3", "c3",  3.05438e-01,  -15., 15.0);
	...
	RooAbsPdf *  BkgPolPdf = new RooChebychev("BkgPolPdf","BkgPolPdf",varMyXmass,RooArgSet(c1,c2,c3,c4,c5));
...
*/
	...
	// myMuMuMuMumassV1mumubelowV1->Rebin();
 //  	RooDataHist alldata("alldata","alldata",varMyXmass, myMuMuMuMumassV1mumubelowV1);
