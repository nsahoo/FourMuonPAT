...
void ExoticmassFitMC() 
{
  ...
  RooRealVar varMyXVtxCL("varMyXVtxCL", "v4#mu VtxCL",0.8, 1.0);
...
*/
  ...
  RooRealVar CBsigma1("CBsigma1","CBsigma1",0.1586284,0.05,1.0);
  RooRealVar CBalpha1("CBalpha1","CBalpha1",1.1,0.0,10.0);
  RooRealVar CBn1("CBn1","CBn1",0.2,0.0,5.0);
  RooAbsPdf * pdfCB1 = new RooCBShape("pdfCB1","pdfCB1",varMyXmass,MyMean1,CBsigma1,CBalpha1,CBn1);
  RooRealVar CBsigma2("CBsigma2","CBsigma2",0.1586284,0.12,1.0);
  RooRealVar CBalpha2("CBalpha2","CBalpha2",-1.0,-10,0.0);
...
*/
  ...
  RooDataSet * alldata= &(RooDataSet::read("myMCfourmuonsignalNolm.txt",variables,"Q"));
