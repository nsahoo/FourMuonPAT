...
process.generator = cms.EDFilter(
	...
	EvtGen = cms.untracked.PSet(
		...
		user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/myBBarnoJpsi.dec'),
	...
	PythiaParameters = cms.PSet(
		...
		bbbarSettings = cms.vstring('MSEL = 5'), # for b-bbar 
                bpdfSettings1 = cms.vstring('KFIN(1,5)=0'), # turn off initial b pdf to avoid bbbar from ISR gluon split to bbbar process via input b quark
                bpdfSettings2 = cms.vstring('KFIN(1,-5)=0'), # turn off initial b pdf
                bpdfSettings3 = cms.vstring('KFIN(2,5)=0'), # turn off initial b pdf
                bpdfSettings4 = cms.vstring('KFIN(2,-5)=0'), # turn off initial b pdf
                gluonSettings = cms.vstring('MSTJ(45) = 4'), # turn off gluon splitting via FSR  
                mpiSettings1 = cms.vstring('MSTP(81)=20'), # turn off MPI, new model from PYEVNT
...
process.ProductionFilterSequence = cms.Sequence(process.generator*process.FourMuonFilter*process.TwoMuonFilter)
