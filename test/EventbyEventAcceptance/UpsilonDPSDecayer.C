...
void UpsilonDPSDecayer(){
    ...
    //ofstream outfile("OveralEvtByEvtEffMap_MuEta2p0.txt");
    //ofstream outfile("OveralTagAndProbeEff_DPSModel_MuEta2p0.txt");
    ...
    ofstream outfile("AcceptanceMapDPS_YRap2p0.txt");
    ...
    TFile* myhbk = new TFile ("DPSAcceptanceDef.root","recreate");
    ...
    ifstream fp("../ReRecoUpsilon/NtupleOut/myFourMuon_DPSGenEvents_ForAcceptance_YRap2p0.txt",ios::in);
    //Reduced File
