...
void ExoticmassFitMCMassPoints_CBBW() 
{
	...
	RooRealVar   MyMean  ("MyMean"    ,"MyMean" , 15,14.5,15.5 );
	...
	// //RooAbsPdf* pdfMyXGauss1 = new RooGaussian( "pdfMyXGauss1", "pdfMyXGauss1",  varMyXmass, MyMean ,Gauswidth1 ) ;
	// RooRealVar BWMean1("BWMean1","BWMean1",18.4344,15.0,22.0);
	RooRealVar BWWidth1("BWWidth1","BWWidth1",0.260748,0.01,3.0);
	RooAbsPdf * pdfBW1 = new RooBreitWigner("pdfBW1","pdfBW1",varMyXmass,MyMean,BWWidth1);
	// RooRealVar BWMean2("BWMean2","BWMean2",18.5535);
	// RooRealVar BWWidth2("BWWidth2","BWWidth2", 0.291299);
	// RooAbsPdf * pdfBW2 = new RooBreitWigner("pdfBW2","pdfBW2",varMyXmass,MyMean,BWWidth2);
	...
	// RooAbsPdf *pdfLandau1 = new RooLandau("pdfLandau1","pdfLandau1",varMyXmass,MyMean,LandauSigma1);



	RooRealVar MyXfrac("MyXfrac","fraction of double gaussian1",3.49987e-01 ,0.0,1.0) ;

	RooRealVar CBsigma1("CBsigma1","CBsigma1",7.90862e-02,0.01,2.0);
	RooRealVar CBalpha1("CBalpha1","CBalpha1",9.34172e-01,-10.0,10.0);
	RooRealVar CBn1("CBn1","CBn1",2.95064e+00,0.0,10.0);
	RooAbsPdf * pdfCB1 = new RooCBShape("pdfCB1","pdfCB1",varMyXmass,MyMean,CBsigma1,CBalpha1,CBn1);
	RooRealVar CBsigma2("CBsigma2","CBsigma2",1.66641e-01,0.0,2.0);
	RooRealVar CBalpha2("CBalpha2","CBalpha2",-2.48465e+00,-10.0,10.0);
	RooRealVar CBn2("CBn2","CBn2",1.01135e+00,0.0,10.0);
	RooAbsPdf * pdfCB2 = new RooCBShape("pdfCB2","pdfCB2",varMyXmass,MyMean,CBsigma2,CBalpha2,CBn2);


	// MyMean.setVal( 1.85007e+01 );
	...
	// RooAbsPdf* pdfMyX = new RooAddPdf("pdfMyX","pdfMyX",RooArgList(*pdfCB1,*pdfLandau1),RooArgList(MyXfrac)); 
	// RooAbsPdf* pdfMyX = new RooAddPdf("pdfMyX","pdfMyX",RooArgList(*pdfCB1,*pdfCB2),RooArgList(MyXfrac)); 
	RooAbsPdf* pdfMyX = new RooAddPdf("pdfMyX","pdfMyX",RooArgList(*pdfCB1,*pdfBW1),RooArgList(MyXfrac)); 
	...
	RooRealVar c1("c1", "c1",-7.37579e-02 ,  -200.0, 200.0);
	RooRealVar c2("c2", "c2",-2.68499e-01 ,  -200., 200.0);
	...
	// MyMean.setVal( myMaxscanmean );MyMean.setConstant();
	...
	// t->SetTextSize(0.045);
	// t->DrawLatex(0.72,0.85,"HLT_Dimuon0_Jpsi_Muon");
	// t->DrawLatex(0.72,0.80,"2011 & 2012");
	// t->DrawLatex(0.72,0.75,"MuOnia");
	// t->DrawLatex(0.72,0.70,"Sig Yield = 14#pm7");
	// t->DrawLatex(0.72,0.65,"Bkg Yield = 389#pm21");

	// c->SaveAs("myFourmuChg0ARCmassandanotherdimultY1sEBE_OnlyJpsiTrig.pdf");
