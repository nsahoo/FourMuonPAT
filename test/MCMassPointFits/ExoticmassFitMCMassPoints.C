...
void ExoticmassFitMCMassPoints() 
{
	...
	double JpsiMassmin=12, JpsiMassmax=18.0;
	...
	RooRealVar   MyMean  ("MyMean"    ,"MyMean" , 15.0,14.0,16.0 );
	...
	RooRealVar CBsigma1("CBsigma1","CBsigma1",7.90862e-02,0.01,1.0);
	RooRealVar CBalpha1("CBalpha1","CBalpha1",9.34172e-01,0.0,2.0);
	RooRealVar CBn1("CBn1","CBn1",2.95064e+00,0.0,5.0);
	RooAbsPdf * pdfCB1 = new RooCBShape("pdfCB1","pdfCB1",varMyXmass,MyMean,CBsigma1,CBalpha1,CBn1);
	RooRealVar CBsigma2("CBsigma2","CBsigma2",1.66641e-01,0.0,1.0);
	RooRealVar CBalpha2("CBalpha2","CBalpha2",-2.48465e+00,-10.0,0.0);
	RooRealVar CBn2("CBn2","CBn2",1.01135e+00,0.0,5.0);
