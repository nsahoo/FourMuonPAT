...
// Thu Feb 18 00:49:56 2016 by ROOT version 5.32/00
// from TTree X_data/X(3872) Data
// found on file: root://cmsxrootd.fnal.gov//store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m11p0/Run2012OMC_ntuple_10_1_9uv.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m11p0/Run2012OMC_ntuple_10_1_9uv.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m11p0/Run2012OMC_ntuple_10_1_9uv.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmsxrootd.fnal.gov//store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m11p0/Run2012OMC_ntuple_10_1_9uv.root:/mkcands");
