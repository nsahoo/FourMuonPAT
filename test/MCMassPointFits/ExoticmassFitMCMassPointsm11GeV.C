...
void ExoticmassFitMCMassPointsm11GeV() 
{
  ...
  RooRealVar   MyMean  ("MyMean"    ,"MyMean"  ,11.0,9.0,12.0 );
...
*/
  ...
  RooRealVar MyXfrac("MyXfrac","fraction of double gaussian1",0.0302285,0.0,1.0) ;

  RooRealVar CBsigma1("CBsigma1","CBsigma1",0.1586284,0.1,1.0);
  RooRealVar CBalpha1("CBalpha1","CBalpha1",2.13,-10.0,10.0);
  RooRealVar CBn1("CBn1","CBn1",0.2,0.0,10.0);
  RooAbsPdf * pdfCB1 = new RooCBShape("pdfCB1","pdfCB1",varMyXmass,MyMean,CBsigma1,CBalpha1,CBn1);
  RooRealVar CBsigma2("CBsigma2","CBsigma2",0.1586284,0.05,0.5);
  RooRealVar CBalpha2("CBalpha2","CBalpha2",2.13,-10.0,10.0);
  RooRealVar CBn2("CBn2","CBn2",1.16,0.0,5.0);
