...
void ExoticmassFitMCMassPoints() 
{
  ...
  RooRealVar   MyMean1  ("MyMean1"    ,"MyMean1"  ,11.0,9.0,13.0 );
...
*/
  ...
  RooRealVar MyXfrac1("MyXfrac1","fraction of double gaussian1",3.49987e-01 ,0.0,1.0) ;

  RooRealVar CBsigma1("CBsigma1","CBsigma1",7.34724e-02,0.001,0.5);
  RooRealVar CBalpha1("CBalpha1","CBalpha1",5.76320e-01,0.0,5.0);
  RooRealVar CBn1("CBn1","CBn1",2.52857e+00,0.0,5.0);
  RooAbsPdf * pdfCB1 = new RooCBShape("pdfCB1","pdfCB1",varMyXmass,MyMean1,CBsigma1,CBalpha1,CBn1);
  RooRealVar CBsigma2("CBsigma2","CBsigma2",0.1586284,0.05,0.9);
  RooRealVar CBalpha2("CBalpha2","CBalpha2",-2.03863e+00,-5.0,0.0);
  RooRealVar CBn2("CBn2","CBn2",1.85372e+00,0.0,5.0);
