...
void ExoticmassFitUpsPull() 
{
	...
	RooRealVar varMyXVtxCL("varMyXVtxCL","varMyXVtxCL",0.0,1.0);
	RooRealVar varMyXPt("varMyXPt", "Pt(X) [GeV]",0.0,100.0);
	RooRealVar varMymumu1mass("varMymumu1mass", "m(#mu^{+}#mu^{-})_1 [GeV]",8.0,11.0);
	...
	RooRealVar   MyMean1  ("MyMean1"    ,"MyMean1"  ,9.46,9.0,10.0 );
	...
	RooAbsPdf * pdfMyXGauss1 = new RooGaussian( "pdfMyXGauss1", "pdfMyXGauss1",  varMymumu1mass, MyMean1 ,Gaussigma1 ) ;
	...
	RooAbsPdf * pdfMyXGauss2 = new RooGaussian( "pdfMyXGauss2", "pdfMyXGauss2",  varMymumu1mass, MyMean1 ,Gaussigma2 ) ;

	RooRealVar   GausMean3  ("GausMean3"    ,"GausMean3"  ,12.5,11.0,14.0 );   
	RooRealVar   Gaussigma3 ("Gaussigma3"    ,"Gaussigma3"  ,1.02644e+00, 0.5,5.0 ); 
	RooAbsPdf * pdfMyXGauss3 = new RooGaussian( "pdfMyXGauss3", "pdfMyXGauss3",  varMymumu1mass, MyMean1 ,Gaussigma3 ) ;
	...
	RooAbsPdf * pdfBW1 = new RooBreitWigner("pdfBW1","pdfBW1",varMymumu1mass,MyMean1,BWWidth1);

	RooRealVar BWMean2("BWMean2","BWMean2",12.0,11.0,13.0);
	RooRealVar BWWidth2("BWWidth2","BWWidth2", 1.5,1.0,3.0);
	RooAbsPdf * pdfBW2 = new RooBreitWigner("pdfBW2","pdfBW2",varMymumu1mass,MyMean1,BWWidth2);
	RooRealVar BWMean3("BWMean3","BWMean3",18.5628/*,15.0,22.0*/);
	RooRealVar BWWidth3("BWWidth3","BWWidth3",0.586284/*,0.01,3.0*/);
	RooAbsPdf * pdfBW3 = new RooBreitWigner("pdfBW3","pdfBW3",varMymumu1mass,BWMean3,BWWidth3);

	RooRealVar LandauMean1("LandauMean1","LandauMean1", 6.55,5.7,7.0);
	RooRealVar LandauSigma1("LandauSigma1","LandauSigma1",1.7,1.0,2.0);
	RooAbsPdf *pdfLandau1 = new RooLandau("pdfLandau1","pdfLandau1",varMymumu1mass,LandauMean1,LandauSigma1);
	...
	RooAbsPdf *pdfLandau2 = new RooLandau("pdfLandau2","pdfLandau2",varMymumu1mass,LandauMean2,LandauSigma2);
	...
	RooExtendPdf *  extendpdfSigMyX = new RooExtendPdf("extendpdfSigMyX","Signal 1 PDF",*pdfMyX, nSigMyX);//single gausssian
	...
	RooDataSet * alldata= &(RooDataSet::read("myfourmuonSignalNoUpsilonMassCut.txt",variables,"Q"));
	...
	c->cd();
	RooPlot *frame = varMymumu1mass.frame( (int)((JpsiMassmax-JpsiMassmin)/mybinwidth) );   //30-12=18
