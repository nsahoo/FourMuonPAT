...
*/
 ...
 // Default
	...
	RooRealVar c1("c1", "c1", -3.91832e-02);
	RooRealVar c2("c2", "c2", -6.01975e-01);
	RooRealVar c3("c3", "c3",  3.24216e-01);
	...
	RooAbsPdf *  BkgPolPdf = new RooChebychev("BkgPolPdf","BkgPolPdf",varMyXmass,RooArgSet(c1,c2,c3));
