...
void ExoticmassFitRootScan_ShortRange_ThreeTrigger_LightMeson() 
{
	...
	double JpsiMassmin=13.0, JpsiMassmax=26.0;
...
*/
 ...
 // Default
	...
	RooRealVar c1("c1", "c1", -8.64923e-02, -2.0, 2.0 );
	RooRealVar c2("c2", "c2", -5.67595e-01, -2., 2.0  );
	RooRealVar c3("c3", "c3",  3.85441e-01, -15., 15.0);
	RooRealVar c4("c4", "c4", -2.17623e-02, -15., 15.0);
	RooRealVar c5("c5", "c5",  3.56614e-01, -15., 15.0);
	RooRealVar c6("c6", "c6", -1.18919e-01, -15., 15.0);
	RooRealVar c7("c7", "c7",  1.51508e-02, -15., 15.0);
 ...
 //  	RooDataHist alldata("alldata","alldata",varMyXmass, myMuMuMuMumassV1mumubelowV1);
	...
	myMuMuMuMumassV1mumubelowV1withlightmeson->Rebin();
  	RooDataHist alldata("alldata","alldata",varMyXmass, myMuMuMuMumassV1mumubelowV1withlightmeson);
	//return;
