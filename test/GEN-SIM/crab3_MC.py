...
config.General.requestName = 'FourMu_BBarMC'



config.section_('JobType')
config.JobType.psetName = 'FourMu_UpsilonInvMassCut_MSEL5_8TeV_pythia6.py'
...
config.Data.outLFNDirBase = '/store/user/sdurgut/FourMuon'
