...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
	...
	fileName = cms.untracked.string('FourMu_BBarMC_0.root'),
...
process.generator = cms.EDFilter(
	...
	EvtGen = cms.untracked.PSet(
		...
		# 	Decay B0
		# 	# ------------- semileptonically ----------------------------
		# 	0.05050000000 D*-     mu+     nu_mu                           PHOTOS HQET 0.77 1.33 0.92;
		...
		# 	0.0003500000 J/psi   omega   K0                              PHSP;
		...
		# 	0.00650000000 D*+     pi-     mu-     anti-nu_mu              PHOTOS   GOITY_ROBERTS;
		...
		# 	Decay Lambda_b0
		# 	# --------- semileptonically ----------------
		# 	0.05000000000 Lambda_c+ mu-     anti-nu_mu                    PHSP;
		# 	0.006300000 Lambda_c(2593)+ mu-     anti-nu_mu              PHSP;
		# 	0.01500000000 Lambda_c(2625)+ mu-     anti-nu_mu              PHSP;
