...
void makeRootFile()
{
	...
	TFile* myoutput = new TFile ("fourmuonmassWithlightmeson.root","recreate");
	...
	std::ifstream infile("7and8TeVcombinedMuOniaDoubleMuwithlightmeson_2SigmaLightMeson.txt");
