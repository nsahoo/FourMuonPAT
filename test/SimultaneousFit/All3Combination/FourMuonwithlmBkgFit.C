...
void FourMuonwithlmBkgFit() 
{
  TFile *f1 = TFile::Open("fourmuonmassWithlightmeson.root");


  double JpsiMassmin=13.0, JpsiMassmax=25.0;
...
*/
  ...
  RooRealVar c1("c1", "c1",-7.98231e-01,  -2.0, 2.0);
  RooRealVar c2("c2", "c2",-6.35648e-01,  -2., 2.0);
  RooRealVar c3("c3", "c3", 8.21620e-01,  -15., 15.0);
  RooRealVar c4("c4", "c4", -2.00482e-01,  -15., 15.0);
  RooRealVar c5("c5", "c5", -2.62969e-01,  -15., 15.0);
  RooRealVar c6("c6", "c6", 1.31791e-01,  -15., 15.0);
 ...
 //  RooAbsPdf * BkgPolPdf = new RooGenericPdf("BkgPolPdf","BkgPolPdf","pow( (m0-varMyXmass),p1 )/pow(varMyXmass,p2+p3*TMath::Log(varMyXmass))",RooArgSet(varMyXmass,m0,p1,p2,p3));
  ...
  myFourMuonMassHist->Rebin(2);  //to avoid empty bins
  RooDataHist alldata("alldata","alldata",varMyXmass, myFourMuonMassHist);
 ...
 //d->Update();
  ...
  cout<<"c4="<<c4.getVal()<<endl;
  cout<<"c5="<<c5.getVal()<<endl;
  cout<<"c6="<<c6.getVal()<<endl;
