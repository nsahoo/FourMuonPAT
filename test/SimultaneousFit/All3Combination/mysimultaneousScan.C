...
void mysimultaneousScan()
{
	...
	RooRealVar   mean  ("mean"    ,"mean"  ,18.466,13.0,25.0 );
	...
	RooRealVar nSigMyX_4muwithlm("nSigMyX_4muwithlm", "Number of signal 1 candidates ", 91,  -20.0, 100000000.0); 
	...
	RooRealVar nBkgPol_4muwithlm("nBkgPol_4muwithlm", "Number of signal 2 candidates ", 600,  0.0, 900000000.0);
	// RooBreit-Wigner
	...
	*/
	...
	// fixed to values with null-hypothesis by excluding the signal region
	c1_2mu2ele.setVal(  1.87361e-01 ); 
	c2_2mu2ele.setVal( -5.65676e-01 );
	// c3_2mu2ele.setVal(  1.86775e-01 );
	// c4_2mu2ele.setVal(  2.01574e-01 );

	c1_4munolm.setVal( -4.54284e-02 );   
	c2_4munolm.setVal( -5.90633e-01 );  
	c3_4munolm.setVal(  3.24436e-01 );
	...
	/*
	c1_4muwithlm.setVal( -0.798548047065898103369363525417 );  c2_4muwithlm.setVal( -0.635678003591565232710536292871 );  c3_4muwithlm.setVal( 0.821747471781410609992235549726 );  
	c4_4muwithlm.setVal( -0.20063621716148638540744286729 );  c5_4muwithlm.setVal( -0.262905046176516776768039562739 );  c6_4muwithlm.setVal( 0.131744864003168871136040252168 );

	 
	c1_4muwithlm.setConstant();  c2_4muwithlm.setConstant();  c3_4muwithlm.setConstant();  
	c4_4muwithlm.setConstant();  c5_4muwithlm.setConstant();  c6_4muwithlm.setConstant();
	*/
	
	c1_4muwithlm.setVal( -5.16225e-01 );  
	c2_4muwithlm.setVal( -8.15639e-01 );  
	c3_4muwithlm.setVal(  5.57045e-01 );
	c4_4muwithlm.setVal(  1.34298e-01 );   
	c5_4muwithlm.setVal( -1.33988e-01 );

	c1_4muwithlm.setConstant();
	c2_4muwithlm.setConstant();
	c3_4muwithlm.setConstant();
	c4_4muwithlm.setConstant();   
	c5_4muwithlm.setConstant();
	...
	*/
	...
	RooPlot* frame1 = x.frame(Bins(60),Title("Upsilon mu+mu- w/o light mesons")) ;
	...
	//frame2->SetMaximum(120);
 	...
 	// Make a frame for the physics sample
	RooPlot* frame3 = x.frame(Bins(60),Title("Upsilon mu+mu- w/ light mesons")) ;
	...
	l1->SetLineColor(2);
	l1->Draw();
	TLine *l2=new TLine(18.430,-1,18.430,1);
	l2->SetLineColor(4);
	l2->Draw();
	TLine *l3=new TLine(18.504,-1,18.504,1);
	l3->SetLineColor(4);
	l3->Draw();
