...
// Tue May 24 22:02:55 2016 by ROOT version 5.32/00
// from TTree X_data/X(3872) Data
// found on file: /eos/uscms/store/user/sdurgut/FourMuon/NTUPLE-H02UpsMuMu_ArtifactTest/Run2012_FourMuon_ntuple_52.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<bool>    *MyMu1TrigMatchVtxSD;
   vector<bool>    *MyMu2TrigMatchVtxSD;
   vector<bool>    *MyMu3TrigMatchVtxSD;
   vector<bool>    *MyMu4TrigMatchVtxSD;
   vector<bool>    *MyMu1TrigMatchL3FilterSD;
   vector<bool>    *MyMu2TrigMatchL3FilterSD;
   vector<bool>    *MyMu3TrigMatchL3FilterSD;
   vector<bool>    *MyMu4TrigMatchL3FilterSD;
   ...
   TBranch        *b_MyMu1TrigMatchVtxSD;   //!
   TBranch        *b_MyMu2TrigMatchVtxSD;   //!
   TBranch        *b_MyMu3TrigMatchVtxSD;   //!
   TBranch        *b_MyMu4TrigMatchVtxSD;   //!
   TBranch        *b_MyMu1TrigMatchL3FilterSD;   //!
   TBranch        *b_MyMu2TrigMatchL3FilterSD;   //!
   TBranch        *b_MyMu3TrigMatchL3FilterSD;   //!
   TBranch        *b_MyMu4TrigMatchL3FilterSD;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/sdurgut/FourMuon/NTUPLE-H02UpsMuMu_ArtifactTest/Run2012_FourMuon_ntuple_52.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/sdurgut/FourMuon/NTUPLE-H02UpsMuMu_ArtifactTest/Run2012_FourMuon_ntuple_52.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/sdurgut/FourMuon/NTUPLE-H02UpsMuMu_ArtifactTest/Run2012_FourMuon_ntuple_52.root:/mkcands");
...
void myntuple::Init(TTree *tree)
{
   ...
   MyFourMuonCTau = 0;
   MyFourMuonCTauErr = 0;
   MyMu1TrigMatchVtxSD = 0;
   MyMu2TrigMatchVtxSD = 0;
   MyMu3TrigMatchVtxSD = 0;
   MyMu4TrigMatchVtxSD = 0;
   MyMu1TrigMatchL3FilterSD = 0;
   MyMu2TrigMatchL3FilterSD = 0;
   MyMu3TrigMatchL3FilterSD = 0;
   MyMu4TrigMatchL3FilterSD = 0;
   MyHitBeforeVrtx = 0;
   MyMissAfterVrtx = 0;
   My1234Mass = 0;
   My1324Mass = 0;
   ...
   fChain->SetBranchAddress("MyMu1TrigMatchVtxSD", &MyMu1TrigMatchVtxSD, &b_MyMu1TrigMatchVtxSD);
   fChain->SetBranchAddress("MyMu2TrigMatchVtxSD", &MyMu2TrigMatchVtxSD, &b_MyMu2TrigMatchVtxSD);
   fChain->SetBranchAddress("MyMu3TrigMatchVtxSD", &MyMu3TrigMatchVtxSD, &b_MyMu3TrigMatchVtxSD);
   fChain->SetBranchAddress("MyMu4TrigMatchVtxSD", &MyMu4TrigMatchVtxSD, &b_MyMu4TrigMatchVtxSD);
   fChain->SetBranchAddress("MyMu1TrigMatchL3FilterSD", &MyMu1TrigMatchL3FilterSD, &b_MyMu1TrigMatchL3FilterSD);
   fChain->SetBranchAddress("MyMu2TrigMatchL3FilterSD", &MyMu2TrigMatchL3FilterSD, &b_MyMu2TrigMatchL3FilterSD);
   fChain->SetBranchAddress("MyMu3TrigMatchL3FilterSD", &MyMu3TrigMatchL3FilterSD, &b_MyMu3TrigMatchL3FilterSD);
   fChain->SetBranchAddress("MyMu4TrigMatchL3FilterSD", &MyMu4TrigMatchL3FilterSD, &b_MyMu4TrigMatchL3FilterSD);
