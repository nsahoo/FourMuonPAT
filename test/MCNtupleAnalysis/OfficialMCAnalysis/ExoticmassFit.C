...
void ExoticmassFit() 
{
	...
	RooRealVar varMymu11Pt("varMymu11Pt", "Pt(#mu)_11 [GeV]",4.5,100.0);
	RooRealVar varMymu12Pt("varMymu12Pt", "Pt(#mu)_12 [GeV]",4.5,100.0);
	RooRealVar varMymu21Pt("varMymu21Pt", "Pt(#mu)_21 [GeV]",4.5,100.0);
	RooRealVar varMymu22Pt("varMymu22Pt", "Pt(#mu)_22 [GeV]",4.5,100.0);
	...
	RooRealVar nSigMyX("nSigMyX", "Number of signal 1 candidates ", 10000,  -10.0, 100000000.0); 
	...
	*/
	...
	RooAbsPdf *  BkgPolPdf = new RooChebychev("BkgPolPdf","BkgPolPdf",varMyXmass,RooArgSet(c1));
