...
// Tue Mar  8 12:26:08 2016 by ROOT version 5.32/00
// from TTree X_data/X(3872) Data
// found on file: /eos/uscms/store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m18p5_doMC/Run2012OMC_ntuple_1.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<bool>    *MyFourMuonSharedSegofMuon1_Check;
   vector<bool>    *MyFourMuonSharedSegofMuon2_Check;
   vector<bool>    *MyFourMuonSharedSegofMuon3_Check;
   vector<bool>    *MyFourMuonSharedSegofMuon4_Check;
   vector<int>     *MyMuonCand_CheckIdx;
   ...
   UInt_t          nHmuMC;
   UInt_t          nxMC;
   vector<float>   *MC_YmuPx;
   vector<float>   *MC_YmuPy;
   vector<float>   *MC_YmuPz;
   vector<float>   *MC_YmuCharge;
   vector<float>   *MC_YmuMother;
   vector<float>   *MC_HmuPx;
   vector<float>   *MC_HmuPy;
   vector<float>   *MC_HmuPz;
   vector<float>   *MC_HmuCharge;
   vector<float>   *MC_HmuMother;
   vector<float>   *MC_xPx;
   vector<float>   *MC_xPy;
   vector<float>   *MC_xPz;
   ...
   TBranch        *b_MyFourMuonSharedSegofMuon1_Check;   //!
   TBranch        *b_MyFourMuonSharedSegofMuon2_Check;   //!
   TBranch        *b_MyFourMuonSharedSegofMuon3_Check;   //!
   TBranch        *b_MyFourMuonSharedSegofMuon4_Check;   //!
   TBranch        *b_MyMuonCand_CheckIdx;   //!
   ...
   TBranch        *b_MC_YmuPy;   //!
   TBranch        *b_MC_YmuPz;   //!
   TBranch        *b_MC_YmuCharge;   //!
   TBranch        *b_MC_YmuMother;   //!
   TBranch        *b_MC_HmuPx;   //!
   TBranch        *b_MC_HmuPy;   //!
   TBranch        *b_MC_HmuPz;   //!
   TBranch        *b_MC_HmuCharge;   //!
   TBranch        *b_MC_HmuMother;   //!
   TBranch        *b_MC_xPx;   //!
   TBranch        *b_MC_xPy;   //!
   TBranch        *b_MC_xPz;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m18p5_doMC/Run2012OMC_ntuple_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m18p5_doMC/Run2012OMC_ntuple_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/lpcbphy/noreplica/sdurgut/FourMuon/Ntuple_OMC_Higgs2MuMu_m18p5_doMC/Run2012OMC_ntuple_1.root:/mkcands");
...
void myntuple::Init(TTree *tree)
{
   ...
   MyFourMuonSharedSegofMuon1_Check = 0;
   MyFourMuonSharedSegofMuon2_Check = 0;
   MyFourMuonSharedSegofMuon3_Check = 0;
   MyFourMuonSharedSegofMuon4_Check = 0;
   MyMuonCand_CheckIdx = 0;
   MyFourMuonVtxCL = 0;
   MyFourMuonVtxC2 = 0;
   MyFourMuonPx = 0;
   MyFourMuonPy = 0;
   ...
   fChain->SetBranchAddress("MyFourMuonSharedSegofMuon1_Check", &MyFourMuonSharedSegofMuon1_Check, &b_MyFourMuonSharedSegofMuon1_Check);
   fChain->SetBranchAddress("MyFourMuonSharedSegofMuon2_Check", &MyFourMuonSharedSegofMuon2_Check, &b_MyFourMuonSharedSegofMuon2_Check);
   fChain->SetBranchAddress("MyFourMuonSharedSegofMuon3_Check", &MyFourMuonSharedSegofMuon3_Check, &b_MyFourMuonSharedSegofMuon3_Check);
   fChain->SetBranchAddress("MyFourMuonSharedSegofMuon4_Check", &MyFourMuonSharedSegofMuon4_Check, &b_MyFourMuonSharedSegofMuon4_Check);
   fChain->SetBranchAddress("MyMuonCand_CheckIdx", &MyMuonCand_CheckIdx, &b_MyMuonCand_CheckIdx);
   ...
   fChain->SetBranchAddress("nYmuMC", &nYmuMC, &b_nYmuMC);
   fChain->SetBranchAddress("nHmuMC", &nHmuMC, &b_nHmuMC);
   fChain->SetBranchAddress("nxMC", &nxMC, &b_nxMC);
   fChain->SetBranchAddress("MC_YmuPx", &MC_YmuPx, &b_MC_YmuPx);
   fChain->SetBranchAddress("MC_YmuPy", &MC_YmuPy, &b_MC_YmuPy);
   fChain->SetBranchAddress("MC_YmuPz", &MC_YmuPz, &b_MC_YmuPz);
   fChain->SetBranchAddress("MC_YmuCharge", &MC_YmuCharge, &b_MC_YmuCharge);
   fChain->SetBranchAddress("MC_YmuMother", &MC_YmuMother, &b_MC_YmuMother);
   fChain->SetBranchAddress("MC_HmuPx", &MC_HmuPx, &b_MC_HmuPx);
   fChain->SetBranchAddress("MC_HmuPy", &MC_HmuPy, &b_MC_HmuPy);
   fChain->SetBranchAddress("MC_HmuPz", &MC_HmuPz, &b_MC_HmuPz);
   fChain->SetBranchAddress("MC_HmuCharge", &MC_HmuCharge, &b_MC_HmuCharge);
   fChain->SetBranchAddress("MC_HmuMother", &MC_HmuMother, &b_MC_HmuMother);
   fChain->SetBranchAddress("MC_xPx", &MC_xPx, &b_MC_xPx);
   fChain->SetBranchAddress("MC_xPy", &MC_xPy, &b_MC_xPy);
   fChain->SetBranchAddress("MC_xPz", &MC_xPz, &b_MC_xPz);
   Notify();
}
