void mysimultaneousfit()
{
	...
	RooRealVar p0_Sigma1("p0_Sigma1","p0_Sigma1",1.76677e-02,1.06677e-02,2.76677e-02);
	RooRealVar p1_Sigma1("p1_Sigma1","p1_Sigma1",3.75986e-03,3.05986e-03,4.75986e-03);
	RooRealVar p2_Sigma1("p2_Sigma1","p2_Sigma1",5.72327e-05,4.72327e-05,6.72327e-05);

	RooRealVar p0_Alpha1("p0_Alpha1","p0_Alpha1",3.89020e-01/*,3.89020e-01,3.89020e-01*/);
	RooRealVar p1_Alpha1("p1_Alpha1","p1_Alpha1",4.74705e-02/*,-100.,100.9*/);
	RooRealVar p2_Alpha1("p2_Alpha1","p2_Alpha1",-2.16379e-04/*,-100.0,100.15*/);

	RooRealVar p0_n1("p0_n1","p0_n1",4.00931e+00/*,-100.,100.*/);
	RooRealVar p1_n1("p1_n1","p1_n1",-1.56685e-01/*,-100.,100.9*/);
	RooRealVar p2_n1("p2_n1","p2_n1",1.65468e-03/*,-100.0,100.15*/);



	RooRealVar p0_Sigma2("p0_Sigma2","p0_Sigma2", 7.90870e-02 , 6.90870e-02 , 9.90870e-02 );
	RooRealVar p1_Sigma2("p1_Sigma2","p1_Sigma2",3.56044e-03,1.56044e-03,5.56044e-03);
	RooRealVar p2_Sigma2("p2_Sigma2","p2_Sigma2",1.76605e-04,0.06605e-04,3.76605e-04);

	RooRealVar p0_Alpha2("p0_Alpha2","p0_Alpha2",-3.36825e+00/*,-100.,100.*/);
	RooRealVar p1_Alpha2("p1_Alpha2","p1_Alpha2",7.94143e-02/*,-100.,100.9*/);
	RooRealVar p2_Alpha2("p2_Alpha2","p2_Alpha2",-1.17921e-03/*,-100.0,100.15*/);

	RooRealVar p0_n2("p0_n2","p0_n2",-6.58972e-01/*,-100.,100.*/);
	RooRealVar p1_n2("p1_n2","p1_n2",1.50662e-01/*,-100.,100.9*/);
	RooRealVar p2_n2("p2_n2","p2_n2",-2.61478e-03/*,-100.0,100.15*/);


	RooRealVar p0_frac("p0_frac","p0_frac",7.02416e-01,0.0,2.);
	RooRealVar p1_frac("p1_frac","p1_frac",-1.96254e-02,-2.,2.);
	RooRealVar p2_frac("p2_frac","p2_frac",3.49798e-04,0.0,1.);
	...
	RooAbsPdf * pdfCB2_15GeV = new RooCBShape("pdfCB2_15GeV","pdfCB2_15GeV",x15,mean15,*CBsigma2_15GeV,*CBalpha1_15GeV,*CBn1_15GeV);
	RooAbsPdf * pdfCB2_18GeV = new RooCBShape("pdfCB2_18GeV","pdfCB2_18GeV",x18,mean18,*CBsigma2_18GeV,*CBalpha1_18GeV,*CBn1_18GeV);
	RooAbsPdf * pdfCB2_25GeV = new RooCBShape("pdfCB2_25GeV","pdfCB2_25GeV",x25,mean25,*CBsigma2_25GeV,*CBalpha1_25GeV,*CBn1_25GeV);
	RooAbsPdf * pdfCB2_36GeV = new RooCBShape("pdfCB2_36GeV","pdfCB2_36GeV",x36,mean36,*CBsigma2_36GeV,*CBalpha1_36GeV,*CBn1_36GeV);
	RooAbsPdf * pdfCB2_50GeV = new RooCBShape("pdfCB2_50GeV","pdfCB2_50GeV",x50,mean50,*CBsigma2_50GeV,*CBalpha1_50GeV,*CBn1_50GeV);
	...
	c->cd(3) ; gPad->SetLeftMargin(0.15) ; frame4->GetYaxis()->SetTitleOffset(1.4) ; frame4->Draw() ;
	c->cd(4) ; gPad->SetLeftMargin(0.15) ; frame5->GetYaxis()->SetTitleOffset(1.4) ; frame5->Draw() ;
	c->cd(5) ; gPad->SetLeftMargin(0.15) ; frame6->GetYaxis()->SetTitleOffset(1.4) ; frame6->Draw() ;
