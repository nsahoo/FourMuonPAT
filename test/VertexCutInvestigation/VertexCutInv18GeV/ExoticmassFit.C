...
void ExoticmassFit() 
{
  ...
  TFile *f1 = TFile::Open("Combined2011and2012SmallVertexCut.root");
  // TFile *f1 = TFile::Open("Muonia2011and2012SmallVertexCutModMuonID.root");
...
*/
 ...
 /* RooRealVar b1("b1", "b1",  0.0, 1500000.0);
  ...
  // RooRealVar m0("m0", "m0",1.17193e+01, -20.0, 20.0);

  // RooRealVar p1("p1", "p1",2.21571e+00, -10.0, 100.0);
  // RooRealVar p2("p2", "p2",2.71924e+00,-50.0, 50.0);
  // RooRealVar p3("p3", "p3",5.12015e-01, -20.0, 20.0);
  ...
  // RooRealVar m0("m0", "m0",2.16160e+01, -20.0, 20.0);
  // RooRealVar p1("p1", "p1",2.0, -5, 5);
  // RooRealVar p2("p2", "p2",2.52701e+00,-10.0, 20.0);
  // RooRealVar p3("p3", "p3",1.01594e+00, -5.0, 10.0);
  ...
  // RooDataHist *alldata =  new RooDataHist("alldata","alldata",varMyXmass, myMuMuMuMumassV1mumubelowV1);
