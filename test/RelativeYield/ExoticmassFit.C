...
void ExoticmassFit() 
{
  ...
  RooRealVar varMymu11Pt("varMymu11Pt", "Pt(#mu)_11 [GeV]",5.0,100.0);
  RooRealVar varMymu12Pt("varMymu12Pt", "Pt(#mu)_12 [GeV]",5.0,100.0);
  RooRealVar varMymu21Pt("varMymu21Pt", "Pt(#mu)_21 [GeV]",5.0,100.0);
  RooRealVar varMymu22Pt("varMymu22Pt", "Pt(#mu)_22 [GeV]",5.0,100.0);
