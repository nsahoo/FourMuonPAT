...
// Wed May 11 15:38:40 2016 by ROOT version 5.32/00
// from TTree X_data/X(3872) Data
// found on file: /eos/uscms/store/user/lpcbphy/noreplica/sdurgut/CrossSection/FourMuonNtuple/Muonia2012D/MuOnia/crab_Run2012D/160509_201959/0000/Run2012_FourMuon_ntuple_977.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<bool>    *My1234MuonTrigMatch;
   vector<bool>    *My1324MuonTrigMatch;
   vector<bool>    *My1423MuonTrigMatch;
   ...
   TBranch        *b_My1234MuonTrigMatch;   //!
   TBranch        *b_My1324MuonTrigMatch;   //!
   TBranch        *b_My1423MuonTrigMatch;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/lpcbphy/noreplica/sdurgut/CrossSection/FourMuonNtuple/Muonia2012D/MuOnia/crab_Run2012D/160509_201959/0000/Run2012_FourMuon_ntuple_977.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/lpcbphy/noreplica/sdurgut/CrossSection/FourMuonNtuple/Muonia2012D/MuOnia/crab_Run2012D/160509_201959/0000/Run2012_FourMuon_ntuple_977.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/lpcbphy/noreplica/sdurgut/CrossSection/FourMuonNtuple/Muonia2012D/MuOnia/crab_Run2012D/160509_201959/0000/Run2012_FourMuon_ntuple_977.root:/mkcands");
...
void myntuple::Init(TTree *tree)
{
   ...
   My1234MuonTrigMatch = 0;
   My1324MuonTrigMatch = 0;
   My1423MuonTrigMatch = 0;
   MyFourMuonChg = 0;
   MyFourMuonMass = 0;
   MyFourMuonMassErr = 0;
   MyFourMuonCTau = 0;
   ...
   fChain->SetBranchAddress("My1234MuonTrigMatch", &My1234MuonTrigMatch, &b_My1234MuonTrigMatch);
   fChain->SetBranchAddress("My1324MuonTrigMatch", &My1324MuonTrigMatch, &b_My1324MuonTrigMatch);
   fChain->SetBranchAddress("My1423MuonTrigMatch", &My1423MuonTrigMatch, &b_My1423MuonTrigMatch);
