...
RooDataSet * alldata= &(RooDataSet::read("haha.txt",variables,"Q"));
  ...
  //  RooDataSet * alldata= &(RooDataSet::read("NooverlapchkEithermodoldmuonidormodnewilseidcombined2011and2012MuOniaDoubleMu.txt",variables,"Q"));
//  RooDataSet * alldata= &(RooDataSet::read("Eithermodoldmuonidormodnewilseidcombined2011and2012MuOniaDoubleMu.txt",variables,"Q"));

//  RooDataSet * alldata= &(RooDataSet::read("combined2011and2012MuOniaDoubleMu.txt",variables,"Q"));
