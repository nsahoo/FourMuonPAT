...
{  
	...
	TString mysignaloutname2011=outputname+"myfourmuonsignal2011.txt";
	ofstream myoutfilesignal2011(mysignaloutname2011);

	TString mysignaloutname2012=outputname+"myfourmuonsignal2012.txt";
	ofstream myoutfilesignal2012(mysignaloutname2012);
	...
	TH1F* myMuMuMuMumass2011Data = new TH1F("myMuMuMuMumass2011Data","myMuMuMuMumass2011Data",10000,0,1000.0);
	TH1F* myMuMuMuMumass2012Data = new TH1F("myMuMuMuMumass2012Data","myMuMuMuMumass2012Data",10000,0,1000.0);
							...
							) 
						{
							...
							{			
									...
									)
								{
									...
									if(runNum < 185000)
									{
										myMuMuMuMumass2011Data->Fill(myfourmuonmass);
										myoutfilesignal2011<<myfourmuonmass<<" "<<(*MyFourMuonMassErr)[myFourMuIdx]
											<<" "<<(*MyFourMuonVtxCL)[myFourMuIdx]
											<<" "<<(rawMup4vect[ muIdxp11 ]+rawMup4vect[ muIdxp12 ] + rawMup4vect[ muIdxp21 ]+rawMup4vect[ muIdxp22 ]).Pt()
											<<" "<<(fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).M()
											<<" "<<(rawMup4vect[ muIdxp11 ]+rawMup4vect[ muIdxp12 ]).Pt()
									...
									if(runNum > 185000)
									{
										myMuMuMuMumass2012Data->Fill(myfourmuonmass);
										myoutfilesignal2012<<myfourmuonmass<<" "<<(*MyFourMuonMassErr)[myFourMuIdx]
											<<" "<<(*MyFourMuonVtxCL)[myFourMuIdx]
											<<" "<<(rawMup4vect[ muIdxp11 ]+rawMup4vect[ muIdxp12 ] + rawMup4vect[ muIdxp21 ]+rawMup4vect[ muIdxp22 ]).Pt()
											<<" "<<(fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).M()
											<<" "<<(rawMup4vect[ muIdxp11 ]+rawMup4vect[ muIdxp12 ]).Pt()
