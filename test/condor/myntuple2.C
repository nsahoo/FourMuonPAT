...
{  
	...
	ofstream myoutfileevtmix(myevtmixname);
	...
	TH1F* myFourMuHighEta = new TH1F("myFourMuHighEta","myFourMuHighEta",300,0,30);
	TH1F* myFourMuLowEta = new TH1F("myFourMuLowEta","myFourMuLowEta",300,0,30);
	TH1F* myFourMuwithUpsilonHighEta = new TH1F("myFourMuwithUpsilonHighEta","myFourMuwithUpsilonHighEta",300,0,30);
	TH1F* myFourMuwithUpsilonLowEta = new TH1F("myFourMuwithUpsilonLowEta","myFourMuwithUpsilonLowEta",300,0,30);


	TH1F* myMuMuonlyWrongmass1 = new TH1F("myMuMuonlyWrongmass1","myMuMuonlyWrongmass1",100000,0,500.0);
	TH1F* myMuMuonlyWrongmass2 = new TH1F("myMuMuonlyWrongmass2","myMuMuonlyWrongmass2",100000,0,500.0);  
	...
	TH1F* myMuMuFrom4Muon_AllPairs = new TH1F("myMuMuFrom4Muon_AllPairs","myMuMuFrom4Muon_AllPairs",800,0,20.0);  
	myMuMuFrom4Muon_AllPairs->GetXaxis()->SetTitle("m(#mu^{+}#mu^{-}) GeV");
	TH1F* myMuMuFrom4Muon_AllPairs_OneYPair = new TH1F("myMuMuFrom4Muon_AllPairs_OneYPair","myMuMuFrom4Muon_AllPairs_OneYPair",800,0,20.0);  
	myMuMuFrom4Muon_AllPairs_OneYPair->GetXaxis()->SetTitle("m(#mu^{+}#mu^{-}) GeV");

	TH1F* myMuMuPairsFrom4Muon_Charge = new TH1F("myMuMuPairsFrom4Muon_Charge","myMuMuPairsFrom4Muon_Charge",4,-2,2);
	...
	bool isFilledFrompidx1 = false;
				...
				//for(int mypidx=2; mypidx>0; mypidx--) //loop over the two combinations with zero chg, low mass combination first
				{
						...
						)
					{
						...
						myMuMuFrom4Muon_AllPairs->Fill( (fitMup4vect[muIdxp11]+fitMup4vect[muIdxp12]).M() );
						myMuMuFrom4Muon_AllPairs->Fill( (fitMup4vect[muIdxp21]+fitMup4vect[muIdxp22]).M() );

						bool isOnePairY = false;
						float mu1mu2MassFromPair1 = -99999;
						float mu3mu4MassFromPair1 = -99999;

						isOnePairY = fabs((fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).M() -mymV )<= mynsigma*myEBEscale*myMupMumMassErr[mypidx][0]
								||  fabs((fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp22 ]).M() -mymV )<= mynsigma*myEBEscale*myMupMumMassErr[mypidx][0];
						...
						{
							//mu1mu2 is upsilon
							if ( fabs((fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).M() -mymV )<= mynsigma*myEBEscale*myMupMumMassErr[mypidx][0] )
							{
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp21]+fitMuCharge[muIdxp22]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp11]+fitMuCharge[muIdxp22]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp21]+fitMuCharge[muIdxp12]) );

								myMuMuFrom4Muon_AllPairs_OneYPair->Fill( (fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp22 ]).M() );
								myMuMuFrom4Muon_AllPairs_OneYPair->Fill( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp22 ]).M() );
								myMuMuFrom4Muon_AllPairs_OneYPair->Fill( (fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp12 ]).M() );
								isFilled = true;
							}
							//mu3mu4 is upsilon
							if ( (fabs((fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp22 ]).M() -mymV )<= mynsigma*myEBEscale*myMupMumMassErr[mypidx][0] ) && isFilled == false  )
							{
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp11]+fitMuCharge[muIdxp12]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp11]+fitMuCharge[muIdxp22]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp21]+fitMuCharge[muIdxp12]) );

								myMuMuFrom4Muon_AllPairs_OneYPair->Fill( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).M() );
								myMuMuFrom4Muon_AllPairs_OneYPair->Fill( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp22 ]).M() );
								myMuMuFrom4Muon_AllPairs_OneYPair->Fill( (fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp12 ]).M() );
								isFilled = true;
							...
							//mu1mu4 is upsilon
							if ( (fabs((fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp22 ]).M() -mymV )<= mynsigma*myEBEscale*myMupMumMassErr[mypidx][0]) && isFilled == false )
							{
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp11]+fitMuCharge[muIdxp12]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp21]+fitMuCharge[muIdxp22]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp21]+fitMuCharge[muIdxp12]) );
							...
							//mu3mu2 is upsilon
							if ( (fabs((fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp12 ]).M() -mymV )<= mynsigma*myEBEscale*myMupMumMassErr[mypidx][0]) && isFilled == false )
							{
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp11]+fitMuCharge[muIdxp12]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp21]+fitMuCharge[muIdxp22]) );
								myMuMuPairsFrom4Muon_Charge->Fill( (fitMuCharge[muIdxp11]+fitMuCharge[muIdxp22]) );
							...
							) 
						{
							...
							{			
								...
								// Light meson study
								if( 1
									&& fabs((fitMup4vect[ muanotherIdxp11 ]+ fitMup4vect[ muanotherIdxp12 ]).M()-3.096919)> myMupMumMassErr[myanotherpidx][0]*myexclnsigma
								...
								if( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).Eta() > 1.2 )
								{
									myFourMuwithUpsilonHighEta->Fill(myfourmuonmass);
								}
								if( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]).Eta() < -1.2 )
								{
									myFourMuwithUpsilonLowEta->Fill(myfourmuonmass);
								}

								if( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]+fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp22 ]).Eta() > 1.2 )
								{
									myFourMuHighEta->Fill(myfourmuonmass);
								}

								if( (fitMup4vect[ muIdxp11 ]+ fitMup4vect[ muIdxp12 ]+fitMup4vect[ muIdxp21 ]+ fitMup4vect[ muIdxp22 ]).Eta() < -1.2 )
								{
									myFourMuLowEta->Fill(myfourmuonmass);
								}
