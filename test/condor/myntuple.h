...
// Wed Mar 11 11:56:54 2015 by ROOT version 5.32/00
// from TTree X_data/X(3872) Data
// found on file: /uscmst1b_scratch/lpc1/lpcphys/yik/myfourmuonNtpl/muonia/reduced/muonia2012A_0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uscmst1b_scratch/lpc1/lpcphys/yik/myfourmuonNtpl/muonia/reducedcopy/muonia2012A_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uscmst1b_scratch/lpc1/lpcphys/yik/myfourmuonNtpl/muonia/reducedcopy/muonia2012A_0.root");
      }
      f->GetObject("X_data",tree);
