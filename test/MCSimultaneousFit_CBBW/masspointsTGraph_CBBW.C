...
void masspointsTGraph_CBBW()
{
	...
	// TF1 *f = new TF1("f","1.92637e+00",5.0,55.0); // CB Alpha
	// TF1 *f = new TF1("f","-6.20436e-03+1.00726e-02*x",5.0,55.0); // CB Sigma
	// TF1 *f = new TF1("f","1.93038e+00-2.84119e-02*x",5.0,55.0); // CB n
	TF1 *f = new TF1("f","7.69143e-01-4.65187e-03*x",5.0,55.0); // Fraction
	f->SetLineColor(4);
	f->Draw("same");
	// Fraction
