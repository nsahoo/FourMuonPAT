...
config.General.workArea = 'crab_pickevents_Muonia2012D'


config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/cvmfs/cms.cern.ch/slc6_amd64_gcc472/cms/cmssw/CMSSW_5_3_32/src/PhysicsTools/Utilities/configuration/copyPickMerge_cfg.py'
...
config.Data.outLFNDirBase = '/store/user/sdurgut/FourMuon/PickEventwithEBESignalRegion'
