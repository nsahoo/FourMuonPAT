...
config.General.workArea = 'crab_pickevents_20160911_140402'


config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_13/src/PhysicsTools/Utilities/configuration/copyPickMerge_cfg.py'
